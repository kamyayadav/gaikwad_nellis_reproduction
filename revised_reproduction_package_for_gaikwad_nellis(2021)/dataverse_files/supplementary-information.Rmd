...
# install and load kableExtra and systemfonts
  install.packages("systemfonts")
  install.packages("kableExtra", dependencies = TRUE)
  library(kableExtra)

#make sure to comment out any install.package commands before knitting or running the file
```
...
# winsorize in T1 df
  t1_experiment_df %<>%
    mutate(b_income_000_OUTLIER_FIXED = (squish(t1_experiment_df$b_income, a = 1000, b = 30000)/1000),
